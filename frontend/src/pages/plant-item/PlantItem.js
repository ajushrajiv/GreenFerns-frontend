...
export default function PlantItem({ background, plantName, plantDescription, price}) {
  return (
    <div className="lg:w-80 md:w-70 sm:w-40 h-auto">
        <div className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-100 dark:border-gray-300">
                <img className="rounded-t-lg w-80 h-60" src={background} alt="" />
            <div className="p-5">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-green">{plantName}</h5>
            ...
            <div className="pl-6 pr-6 pb-5 flex justify-between items-center">
                <p className="mb-3 font-bold pt-1 text-gray-700 dark:text-gray-700">{price}</p>  
